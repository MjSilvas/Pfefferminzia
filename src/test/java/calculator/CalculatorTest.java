...
Calculator calc = new Calculator();
    ...
    public void calculatePremium_with_valid_Input(){
        ...
        BigDecimal result1 = calc.calculatePremium("hund", "premium", LocalDate.now().minusYears(7));
        BigDecimal result2 = calc.calculatePremium("katze", "optimal", LocalDate.now().minusYears(3));
        BigDecimal result3 = calc.calculatePremium("kleintier", "kompakt", LocalDate.now().minusYears(1));
        BigDecimal result4 = calc.calculatePremium("Hund", "premium", LocalDate.now().minusYears(26));
    ...
    public void calculatePremium_with_invalid_Input(){
        ...
        BigDecimal result1 = calc.calculatePremium("hund", "premium", LocalDate.now().plusYears(2));
        BigDecimal result2 = calc.calculatePremium("hund", "super", LocalDate.now().minusYears(7));
        BigDecimal result3 = calc.calculatePremium("pferd", "premium", LocalDate.now().minusYears(7));
